  ...
  return (
    <div className="page" data-testid="system-administration-page">
      ...
      <div className="grid grid-kpi" data-testid="admin-health">
        ...
        <KpiCard label="Writeback mode" value={WRITEBACK_LABELS.read_only} tone="at-risk" hint="deployment setting (PPSE_WRITEBACK_MODE); the ERP is never written in read-only mode" />
